...
public class ConsultationController {
    ...
    //    return testRequestService.findByStatus(RequestStatus.LAB_TEST_COMPLETED);
          return testRequestService.findByStatus(RequestStatus.LAB_TEST_COMPLETED);
      //   List<TestRequest> testRequest = testRequestQueryService.findBy(RequestStatus.LAB_TEST_COMPLETED); // replace this line with your code
      //   return testRequest;
    }
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        List<TestRequest> testRequest =  testRequestQueryService.findByDoctor(loggedInUser);
        return testRequest;
